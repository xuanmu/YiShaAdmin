...
CREATE TABLE IF NOT EXISTS `sys_area` (
  ...
  `area_code` varchar(6) COLLATE utf8_bin NOT NULL,
  `parent_area_code` varchar(6) COLLATE utf8_bin NOT NULL,
  `area_name` varchar(50) COLLATE utf8_bin NOT NULL,
  `zip_code` varchar(50) COLLATE utf8_bin NOT NULL,
...
>>>>>>> 00867f73496ddc07b84f9d69f9ebd9c8cffcf6b4
